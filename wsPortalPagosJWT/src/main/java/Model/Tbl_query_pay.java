...
public class Tbl_query_pay {
    ...
    public Tbl_query_pay(int num_formulario, String num_identificacion, String nombre_largo, String email, String fecha_venta, String nombre_unidad, String valor_inscripcion, Date fecha_pago_inscripcion) {
