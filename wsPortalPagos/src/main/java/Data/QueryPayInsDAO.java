...
public class QueryPayInsDAO {
    ...
    private static final String SQL_SELECT
            ...
            + "svi.fec_pag_inscripcion  AS fec_limite_pago, svi.val_inscripcion, f.val_venta as valor_pagado "
     ...
     * @return *
     */
    public List<Tbl_query_pay_ins> get_pay(Tbl_query_pay_ins query_pay, String cod_period) {
        Tbl_query_pay_ins tbl_qpay;
        List<Tbl_query_pay_ins> list_tbl_qpay = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                tbl_qpay = new Tbl_query_pay_ins();
                ...
                tbl_qpay.setValor_pagado(rs.getString("valor_pagado"));
